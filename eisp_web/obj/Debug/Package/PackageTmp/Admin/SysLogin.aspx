          ...
          <TD>
            <TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%" 
              ...
              <TR>
                ...
                <TD><INPUT class=regtxt style="width:50px;" title=请填写后台目录 maxLength=5 size=6 
                   name=Code id="Code" runat="server" onclick="show();"><div id="codeimg" style="height:20px; width:60px; border:solid 0px #ff0000; position:absolute; margin-top:2px; margin-left:3px; display:block;"><img src="CheckCode.aspx" onclick="this.src=this.src+'?'" alt="点击更换图片" /></div>
