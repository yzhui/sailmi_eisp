<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsClassAdmin.aspx.cs" Inherits="Eisp.Web.Admin.News.NewsClassAdmin" %>
...
<body>
    <form id="form1" runat="server">
        <div class="mframe">
            ...
            <tr><td  class="tm" style="text-align:left;"> <span class="tt">资讯分类管理</span></td><td class="tm"></td></tr>
                <tr>
