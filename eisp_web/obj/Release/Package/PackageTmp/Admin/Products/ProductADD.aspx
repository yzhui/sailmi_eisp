<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductADD.aspx.cs" Inherits="Eisp.Web.Admin.Products.ProductADD" %>
                                    ...
                                    <td class="mm" style="height: 100%">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td class="style1" >
                                                    缩略图片：
                                                    <asp:TextBox ID="txtImgPath" runat="server" Width="248px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td >
                                                    ...
                                                    <textarea id="txtGuige" rows="3" runat="server"></textarea>    
                                              ...
                                              <tr>
                                                <td >
                                                    ...
                                                    <textarea id="txtYingyong" rows="3" runat="server"></textarea>    
                                                ...
                                                <td >
                                                    ...
                                                    <textarea id="hangye" rows="3" runat="server"></textarea>    
